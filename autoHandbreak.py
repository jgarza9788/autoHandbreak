...
# TODO
# where you keep your movies and where you want them exported to
root_dir = "D:\Torrents\Movies" 
dest_dir = "D:\Torrents\Movies\H265"
...
def encode(path, dest):
    for root_dir, dirs, files in os.walk(path, topdown=False):
        for name in files:
            ...
            if name.split('.')[-1].upper() in extension_list:
...
# C:\Users\JGarza>D:\Torrents\HandBrakeCLI\HandBrakeCLI.exe --help
# [20:51:25] Compile-time hardening features are enabled
# [20:51:25] hb_init: starting libhb thread
# [20:51:25] thread 1 started ("libhb")
